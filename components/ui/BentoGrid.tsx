...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('shreyasjadhav0526@gmail.com');
    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 translation duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}>
